  ...
  <div class="login-page bg-gray-200 h-screen">
    <div class="container mx-auto p-8">
      <div class="mx-auto max-w-sm">
        ...
        <div class="bg-white rounded shadow">
          <div class="login-form" v-show="!isLoggedIn">
            <div class="border-b py-4 text-center">
              ...
              <div class="login-subtitle text-gray-700 text-md">
                Please log in
              </div>
            </div>
            <div class="bg-grey-lightest px-10 py-5">
              <div class="mb-3">
                <a :href="apiUrl + '/auth/facebook'">
                  <div class="bg-blue-700 py-2 px-4 text-white text-center">
                    Login With Facebook
                  </div>
                </a>
              </div>
            ...
            <div class="bg-grey-lightest px-10 py-5">
              <div class="mb-3">
                <a :href="apiUrl + '/auth/google'">
                  <div class="bg-gray-700 py-2 px-4 text-white text-center">
                    Login With Google
                  </div>
                </a>
              </div>
          ...
          <div class="select-dashboard" v-show="isLoggedIn">
            <div class="flex flex-col border-b py-4 text-center">
              ...
              <div
                class="login-header font-bold text-black text-xl tracking-widest"
              >
                {{ user.name }}
              </div>
              ...
              <div class="w-full" v-show="isBoardsLoaded">
                ...
                >
                  <router-link :to="'/board/' + board._id">
                    <div
                      class="h-full flex items-center hover:border-blue-600 border-gray-300 border px-4 py-2 rounded-lg hover:bg-blue-200"
                    >
                      <div class="flex-grow">
        ...
        <div class="flex logout justify-center mt-4" v-show="isLoggedIn">
          <span class="cursor-pointer italic text-blue-300" @click="logoutEvent"
            >log me out</span
          >
        </div>
      </div>
    ...
    <div class="min-h-screen flex justify-center mx-auto absolute">
      <div class="flex overflow-x-scroll pt-16">
        <vue-tailwind-modal
          :showing="showBoardModal"
          @close="boardModalVisible(false)"
        >
          <board-adder />
        </vue-tailwind-modal>
      </div>
