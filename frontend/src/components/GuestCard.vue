<template>
  <div class="show-on-hover-container bg-white shadow rounded px-3 pt-2 pb-2 border border-white mb-2"
    ...
    <div class="flex flex-row">
      <div class="flex-grow pr-1">
        ...
        <div class="flex justify-between">
          ...
          <button alt="edit guest card"
            class="show-on-hover flex mt-1 justify-between items-center text-center text-sm border-blue-200 rounded px-2 py-1 hover:border-blue-500 hover:bg-blue-200 h-6 w-auto"
            @click="editGuestEvent(guest)">
            <font-awesome-icon icon="edit" size="xs" style="color:cornflowerblue" />
          </button>
          <button alt="remove guest card" class="show-on-hover flex mt-1 justify-between items-center text-center text-sm border-red-200 rounded px-2
            py-1 hover:border-red-500 hover:bg-red-200 h-6 w-auto" @click="removeGuestEvent">
      ...
      <div
        ...
        <div class="flex justify-between items-center text-sm">
          <font-awesome-icon icon="align-justify" size="xs" style="color:black items-center" />
        </div>
      </div>
    </div>
  </div>
